...
technologies --- Visium \citep{stahl2016visium}, MERFISH
\citep{chen2015merfish}, Xenium \citep{janesick2023xenium} and Stereo-seq
\citep{chen2022mosta} (Table~\ref{tab:data}) --- plus one non-spatial
perturbation screen \citep{dixit2016perturbseq} (\NPerturbCells{} dissociated
cells) used only in Section~\ref{sec:results4}.
...
\citep{rasmussen2006gp}, an implicit neural field with Fourier features and
SIREN activations \citep{tancik2020fourier}, and two imputation methods
originally built to transfer expression from dissociated reference data ---
Tangram \citep{biancalani2021tangram} and SpaGE \citep{abdelaal2020spage} ---
adapted here to impute at held-out coordinates within a section. The graph methods were not designed

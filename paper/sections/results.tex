...
Under that common protocol, NMO applied unchanged from adult mouse brain to
...
in-domain gain: NMO fits an operator whose fixed point is the source tissue, and
...
(Appendix~\ref{app:empirical}, Table~\ref{tab:converged}), NMO attains
...
section is reversed. The budget is therefore \emph{conservative} for NMO here
...
than weakens the reading in Section~\ref{sec:results}. And NMO retains the
...
The cost is real: NMO takes \ConvNMOWall\,s against \ConvBaseWallLo--\ConvBaseWallHi\,s
